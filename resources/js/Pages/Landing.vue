...
const footerCols = computed(() => [
    ...
    { title: t('landing.footer.docs'),    links: [t('landing.footer.docs_l1'), t('landing.footer.docs_l2'), t('landing.footer.docs_l3'), t('landing.footer.docs_l4')] },
    { title: t('landing.footer.support'), links: [t('landing.footer.support_l1'), t('landing.footer.support_l2'), t('landing.footer.support_l3'), t('landing.footer.support_l4')] },
    { title: t('landing.footer.legal'),   links: [t('landing.footer.legal_l1'), t('landing.footer.legal_l2'), t('landing.footer.legal_l3'), t('landing.footer.legal_l4')] },
]);
</script>
                ...
                <div class="grid md:grid-cols-5 gap-10">
                    ...
                    <div v-for="col in footerCols" :key="col.title">
                        ...
                        <ul class="space-y-3 text-[13.5px] text-ink-700">
                            <li v-for="l in col.links" :key="l"><a href="#" class="hover:text-ink-900">{{ l }}</a></li>
                        </ul>
                    </div>
                </div>
