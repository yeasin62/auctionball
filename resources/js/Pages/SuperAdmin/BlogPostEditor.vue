...
<template>
    <Head :title="`${isEditing ? 'Edit' : 'New'} Blog Post | Super Admin`" />
    <SuperAdminLayout :title="isEditing ? 'Edit Blog Post' : 'New Blog Post'">
        <div class="grid xl:grid-cols-12 gap-5">
            ...
            <aside class="xl:col-span-5 space-y-5">
                ...
                <section v-if="false" class="glass rounded-2xl p-6">
